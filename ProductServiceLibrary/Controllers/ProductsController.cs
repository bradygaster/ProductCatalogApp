    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ActionResult<List<Product>> GetProductsByCategory(string category)
        {
            try
            {
                ...
                {
                    return BadRequest("Category parameter cannot be null or empty");
                }
        ...
        public ActionResult<List<Product>> GetProductsByPriceRange([FromQuery] decimal minPrice, [FromQuery] decimal maxPrice)
        {
            try
            {
                ...
                {
                    return BadRequest("Price range values must be non-negative");
                }
        ...
        public ActionResult<Product> CreateProduct([FromBody] Product product)
        {
            try
            {
                ...
                if (product.Price < 0)
                {
                    return BadRequest("Product price must be non-negative");
                }
